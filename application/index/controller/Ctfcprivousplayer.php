...
{
    const Previous_PLAYER_FIELD = 'SeasonID, TeamName, PlayerName, Item, GroupAgeID, Sex, Result_time, Result_Distance/Height';
    const FIELD = 'SeasonID, TeamName, PlayerName, Item, GroupAgeID, Sex, Result_time, Result_Distance/Height';
    ...
    public function add()
    {
        ...
        $this->makeNull($data);
        $validator = validate('ctfc_previous_player');
        $result = Db::name('ctfc_previous_player')->insert($data);
    ...
    {
        $data = request()->only(self::Previous_PLAYER_FIELD, 'post');
        $this->makeNull($data);
        ...
        $player["GroupAgeID"] = $data["GroupAgeID"];
        $player["Sex"] = $data["Sex"];
        $player["Result_time"] = $data["Result_time"];
        $player["Result_Distance/Height"]= $data["Result_Distance/Height"];

        // Check if player with the same name and birthday already exists
        $existingPlayer = Db::name('ctfc_previousplayer')
