...
<div class="inside-banner block statistics-banner">
    <h3>球员排行</h3>
    <p>查看<?php echo $thisseason['SeasonName']; ?>的球队排行榜</p>
</div>
<div class="site-box">
    <div class="block">
        <span class="icon-home home_icon icon"></span>
        <a href="<?php echo url('index'); ?>">首页</a>
        <span class="icon-arrow-right arrow_icon icon"></span>
        <a href="<?php echo url('index/bbseason/read',['id'=>$thisseason['SeasonID']]); ?>"><?php echo $thisseason['SeasonName']; ?></a><span class="icon-arrow-right arrow_icon icon"></span>
        <span class="active">球队排行</span>
    </div>
</div>
</div>
<div class="pro-wrap">
    <div class="clearfix block">
        <div class="public-left">
			<div class="title-box">
                <?php echo $thisseason['SeasonName']; ?> - 球队排行
                </div>
            ...
            <table class="table">
                ...
                <tbody>
                <?php if(!$teamrankresult): ?>
                <tr>
                    <td>暂没有可用排行！</td>
                </tr>
                <?php endif; if(is_array($teamrankresult) || $teamrankresult instanceof \think\Collection || $teamrankresult instanceof \think\Paginator): $i = 0; $__LIST__ = $teamrankresult;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$teamrank): $mod = ($i % 2 );++$i;?>
                <tr>
                    <td><?php echo $i; ?></td>
                    <td><?php echo $teamrank['ShortName']; ?></td>
                    <td><?php echo $teamrank['Wins']; ?></td>
                    <td><?php echo $teamrank['Losses']; ?></td>
                </tr>
        ...
        <div class="public-right">
            <div class="tab-box">
                <h3>项目信息</h3>
                <ul>
                    <li><a href="<?php echo url('index/bbseason/read',['id'=>$thisseason['SeasonID']]); ?>"><span class="icon-chevron-right2 icon"></span>赛场列表</a></li>
                    ...
                    <li>
                        <dl>
                            <dt>排行榜</dt>
                            <dd class="active"><a href="<?php echo url('index/bbteam/rank',['seasonid'=>$thisseason['SeasonID']]); ?>">球队排行<span class="icon-chevron-right2 icon"></a></dd>
